...
<body>
      ...
      <div class="row g-4 justify-content-between align-items-center">
        <div class="col-lg-6">
          <div class="hero-content">
            <h6 class="wow fadeInUp">Welcome to Rupees24</h6>
            <h1 class="wow fadeInUp" data-wow-delay=".3s">
              Play games, win cash, withdraw instantly!
            </h1>
            <p class="wow fadeInUp" data-wow-delay=".5s">
              There are countless ways to enjoy gaming, but only Rupees24 lets
              you turn your skills into real earnings. Join thousands of
              players and start winning today!
            </p>
            <div class="hero-button">
              <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                <a href="https://play.google.com/store/apps/details?id=com.rupees24.codestrup&pcampaignid=web_share"
                  target="_blank">
                  <span class="theme-btn">Download The App </span><span class="arrow-btn"><i
                      class="fa-regular fa-arrow-up-right"></i></span></a>
              </div>
        ...
        <div class="brand-wrapper-2">
          ...
          <div class="swiper brand-slider">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="brand-img center">
                  <img src="assets/img/godspeed.png" alt="img" />
                </div>
              </div>
              <div class="swiper-slide">
                <div class="brand-img center">
                  <img src="assets/img/Blogvlogz.png" alt="img" />
                </div>
              </div>
              <div class="swiper-slide">
                <div class="brand-img center">
                  <img src="assets/img/blogwire.webp" alt="img" />
                </div>
              </div>
              <div class="swiper-slide">
                <div class="brand-img center">
  ...
  <section class="feature-secton section-padding fix">
    ...
    <div class="container">
      <div class="section-title-area">
        ...
        <p class="wow fadeInUp" data-wow-delay=".5s">
          Rupees24 lets you play, win, and withdraw real <br />
          cash instantly while enjoying exciting games.
        </p>
      </div>
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
          <div class="feature-box-items">
            ...
            <div class="content">
              <h3>Select a Plan</h3>
              <p>
                Choose the best plan! Silver, Gold, or Diamond – all are worth
                it!
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
          <div class="feature-box-items">
            ...
            <div class="content">
              <h3>Pay Entry Fee</h3>
              <p>
                Easy payments & instant subscription for a seamless
                experience!
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
          <div class="feature-box-items">
            ...
            <div class="content">
              <h3>Play & Get Paid!</h3>
              <p>
                Start earning smart! Play games, win cash, withdraw fast &
                repeat!
              </p>
            </div>
          </div>
  ...
  <!-- <section class="service-section fix section-bg section-padding pt-0">
      ...
      <div class="container">
        <div class="section-title-area">
          ...
          <div class="main-button wow fadeInUp" data-wow-delay=".3s">
            <a href="service.html">
              <span class="theme-btn">EXPLORE MORE </span
              ><span class="arrow-btn"
                ><i class="fa-regular fa-arrow-up-right"></i></span
            ></a>
          </div>
        </div>
        <div class="row">
          ...
          >
            <div class="service-card-items">
              ...
              <div class="content">
                <p>
                  Collaboratively formulate principle capital doing
  ...
  <!-- <section class="cta-marketing section-padding pt-0">
      ...
      <div class="container">
        <div class="cta-marketing-wrapper">
          ...
          <div
            class="cta-marketing-image wow img-custom-anim-right"
            ...
            <div class="col-lg-6">
              <div class="about-content">
                ...
                <div class="about-button">
                  <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                    <a href="about.html">
                      <span class="theme-btn">ABOUT US MORE </span
                      ><span class="arrow-btn"
                        ><i class="fa-regular fa-arrow-up-right"></i></span
                    ></a>
                  </div>
    ...
    >
      <div class="container">
        ...
        <div class="case-studies-wrapper-2">
          <div class="case-studies-items bor-top bor-bottom">
            <div class="content">
              <h3><a href="project-details.html">PPC Advertising</a></h3>
              <span>MARKETING</span>
              <p>
            ...
            <div
              class="case-studies-hover d-none d-lg-block bg-cover"
              style="
                background-image: url('assets/img/case-studies/hover-img.png');
              "
            ></div>
          </div>
          <div class="case-studies-items bor-bottom">
            <div class="content">
          ...
          <div class="case-studies-items bor-bottom">
            <div class="content">
              <h3><a href="project-details.html">Content Marketing</a></h3>
              <span>MARKETING</span>
              <p>
                There are many variations of passages of Lorem Ipsum available,
                but the majority have suffered alteration in some form, by
        ...
        <div class="row g-4 justify-content-between">
          <div class="col-xl-5 col-lg-6">
            <div class="faq-content">
              ...
              <p class="wow fadeInUp" data-wow-delay=".5s">
                We’re not just another gaming platform—we’re your gateway to exciting rewards and endless entertainment.
                With a passion for gaming and a commitment to delivering the best experience, we ensure seamless
                gameplay and real winnings.
              </p>
              <ul class="faq-list">
                ...
                <div class="accordion" id="accordion">
                  <div class="accordion-item mb-3 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                      <div class="accordion-body">
                        You can download the APK directly from our official website. Simply enable "Install from Unknown
                        Sources" in your device settings and follow the on-screen instructions.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item mb-3 wow fadeInUp" data-wow-delay=".5s">
                    <h5 class="accordion-header">
                      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq2"
                        ...
                        Is the game safe and secure?
                      </button>
                    </h5>
                    <div id="faq2" class="accordion-collapse show" data-bs-parent="#accordion">
                      <div class="accordion-body">
                        Yes! We prioritize user security with encrypted transactions and fair gaming policies. Your data
                        and earnings are always protected.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item mb-3 wow fadeInUp" data-wow-delay=".7s">
                    ...
                    <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#accordion">
                      <div class="accordion-body">
                        Once you reach the minimum withdrawal amount, you can request a payout via UPI or bank transfer.
                        Withdrawals are processed quickly to ensure a hassle-free experience.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item mb-0 wow fadeInUp" data-wow-delay=".7s">
                    ...
                    <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#accordion">
                      <div class="accordion-body">
                        Yes! We offer free practice games so you can experience the gameplay before participating in
  ...
  <!-- <section class="cta-contact-section fix section-padding">
      <div class="container">
        <div
          class="cta-contact-wrapper bg-cover"
          style="background-image: url('assets/img/cta-contact-bg.jpg')"
        >
          <div
            class="cta-image wow img-custom-anim-left"
            data-wow-duration="1.5s"
            data-wow-delay="0.3s"
          >
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-card-items">
                      ...
                      <p>
                        I’ve tried so many apps, but Rupees24 is by far the best. The games are super fun, and the best
                        part? The withdrawals are lightning-fast! I cashed out twice, and both times the money was in my
                        account within minutes. Highly recommend!
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-card-items">
                      ...
                      <p>
                        Easy to use app with a variety of ways to earn rewards. Fun and engaging tasks make earning feel
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-card-items">
                      ...
                      <p>
                        Rupees24 is very user-friendly. Just play games, win, and withdraw—no long process, no waiting.
        ...
        <div class="row">
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="news-box-items">
              <div
                class="news-image wow img-custom-anim-top"
                data-wow-duration="1.5s"
                data-wow-delay="0.2s"
              >
              ...
              <div class="news-content">
                ...
                <h5>
                  <a href="news-details.html"
                    >Importers achieve savings through the First Sale rule!</a
                  >
                </h5>
                <div class="news-btn">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="news-box-items">
              ...
              <div class="news-content">
                ...
                <h5>
                  <a href="news-details.html"
                    >Is now the right time to invest in an enterprise</a
                  >
                </h5>
                <div class="news-btn">
                  <a href="news-details.html" class="link-btn"
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="news-box-items">
              ...
              <div class="news-content">
                ...
                <h5>
                  <a href="news-details.html"
                    >Focus logistics secure new landmark Contracts</a
                  >
                </h5>
                <div class="news-btn">
                  <a href="news-details.html" class="link-btn"
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="news-box-items">
              ...
              <div class="news-content">
                ...
                <h5>
                  <a href="news-details.html"
                    >Transid Named a Finalist For Year’ 25 Best Choice
                  </a>
                </h5>
                <div class="news-btn">
                  <a href="news-details.html" class="link-btn"
